...
double safe_coulex_angle(double AB,double Z1,double AT,double Z2,double E_lab); //[Inputs(A1,Z1,A2,Z2,E_lab)]

// Returns the maximum beam energy for safe coulex distance of approach for a given CM beam scattering angle
double safe_coulex_beam(double AB,double Z1,double AT,double Z2,double rad_cm=pi); //[Inputs(A1,Z1,A2,Z2,rad_cm)]
