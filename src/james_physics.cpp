...
double classical_barrier(double A1,double Z1,double A2,double Z2,double extrafm){ //input AZAZ,fm output in MeV
	return jam_phys_e4pieps*round(Z1)*round(Z2)/(classical_radius(A1)+classical_radius(A2)+extrafm);
}
